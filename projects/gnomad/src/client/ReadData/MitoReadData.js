...
class MitoReadData extends Component {
  static propTypes = {
...
const TestContainer = ({ variantIds }) => {
      ...
      ${variantIds
        .map(
          (
            variantId,
            i
          ) => `variant_${i}: variantReads(variantId: "${variantId}") {
        exome {
          bamPath
          category
          indexPath
