...
def populate_gtex():
	ht = hl.import_table('/home/ubuntu/data/GTEx_Analysis_2016-01-15_v7_RSEMv1.2.22_transcript_tpm_medians_by_tissue_wo_versions.tsv.gz',delimiter='\t',key='transcript_id',force_bgz=True,impute=True)
